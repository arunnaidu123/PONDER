...
int *ignored_channels(FILE *ignfile, int nchans) ;
int little_endian() ;
int np2(int n) ;
...
void send_float(char *name,float floating_point, FILE *output) ;
void send_int(char *name, int integer, FILE *output) ;
void send_long(char *name, long integer, FILE *output) ;
