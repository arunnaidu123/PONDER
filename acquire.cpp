...
int shmid,statusId,sem_id;//semaphore IDs 
int err=0; 
...
int main()
{
  ...
  //if(adc.correlation==0 && adc.ips == 0) data = (char*) malloc(adc.bufferLen);
  //if(adc.vlbi==1) data2 = (char*) malloc(MEGA_B(adc.segment));
  if(adc.correlation==1 || adc.ips == 1 || adc.mixing == 1) 
  {
    printf("data allocated");
    //data0 = (char*) malloc(adc.bufferLen);
    //data1 = (char*) malloc(adc.bufferLen);
    //data2 = (char*) malloc(adc.bufferLen);
    //data3 = (char*) malloc(adc.bufferLen);
  }
  if(adc.gpu == 1) 
  {
    printf("data allocated");
    //data2 = (char*) malloc(MEGA_B(128));
    //data3 = (char*) malloc(MEGA_B(128));
    //data2 = (char*) malloc(adc.bufferLen);
    //data3 = (char*) malloc(adc.bufferLen);
  }  
